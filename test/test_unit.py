...
def test_begin_message():
    ...
    assert decoded_msg.commit_ts == datetime.strptime("2021-04-20 22:13:16.867121+00:00".split('+')[0], "%Y-%m-%d %H:%M:%S.%f").astimezone(timezone.utc)
...
def test_commit_message():
    ...
    assert decoded_msg.commit_ts == datetime.strptime("2021-04-20 23:01:08.279969+00:00".split('+')[0], "%Y-%m-%d %H:%M:%S.%f").astimezone(timezone.utc)
